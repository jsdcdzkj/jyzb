  ...
  <div class="app-container">
    ...
    <div class="container-main mt16">
      <div class="container-left">
        <div class="box-card">
          <moduleTitle title="车辆数量趋势" :imgUrl="require('@/assets/layout/icon_qushi.png')"></moduleTitle>
          <div class="line-charts" style="margin-top: -34px;">
            <taskLine :valdata="taskLineData"></taskLine>
          </div>
        </div>
        <div class="box-card mt16">
          <moduleTitle title="车辆类型分析" :imgUrl="require('@/assets/layout/icon_leixing.png')"></moduleTitle>
        ...
        <div class="box-card mt16">
          <moduleTitle title="分局车辆数据" :imgUrl="require('@/assets/layout/icon_fenju.png')"></moduleTitle>
      ...
      <div class="container-right">
        <div class="box-card">
          <moduleTitle title="车辆类型占比" :imgUrl="require('@/assets/layout/icon_all.png')"></moduleTitle>
