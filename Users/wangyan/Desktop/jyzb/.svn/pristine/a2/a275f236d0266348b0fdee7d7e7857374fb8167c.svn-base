  ...
  <div class="app-container">
    ...
    <div class="container-main mt16">
      <div class="container-left">
        <div class="box-card">
          <moduleTitle title="装备数量趋势" :imgUrl="require('@/assets/layout/icon_qushi.png')"></moduleTitle>
          <div class="line-charts" style="margin-top: -34px;">
            <taskLine :valdata="taskLineData"></taskLine>
          </div>
        </div>
        <div class="box-card mt16">
          <moduleTitle title="装备类型分析" :imgUrl="require('@/assets/layout/icon_leixing.png')"></moduleTitle>
        ...
        <div class="box-card mt16">
          <moduleTitle title="分局装备数量" :imgUrl="require('@/assets/layout/icon_fenju.png')"></moduleTitle>
      ...
      <div class="container-right">
        <div class="box-card">
          <moduleTitle title="全部装备类型占比" :imgUrl="require('@/assets/layout/icon_all.png')"></moduleTitle>
...
export default {
  ...
  data() {
    return {
      totalData:[{
        ...
        name:'使用装备总数',
        val:0,
        img:require('@/assets/layout/static-e.png')
      },{
        name:'过期装备总数',
        val:0,
        img:require('@/assets/layout/static-g.png')
      },{
        name:'临期装备总数',
        val:0,
        img:require('@/assets/layout/static-f.png')
      }],
      taskLineData:{
  ...
  created(){
    getEquipNum().then(res=>{
      this.totalData[0].val = res.data.totalNum;
      this.totalData[1].val = res.data.stockNum;
      this.totalData[2].val = res.data.useNum;
      this.totalData[3].val = res.data.expiredNum;
      this.totalData[4].val = res.data.criticalNum;
    })
  },
  mounted() {
    getEquipTrend().then(res=>{
      const data = res.data||[];
      let xLabel = [];
      let dataNumA = [];
      let dataNumB = [];
