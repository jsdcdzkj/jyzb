...
/**
 * ClassName: WarehousingManagement
 * Description:  入库管理 入库单管理
 *
 * @author zhangdequan
 */
@Entity
@TableName("warehousing_management")
@Table(name = "warehousing_management")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class WarehousingManagement extends Model<WarehousingManagement> implements Serializable {
