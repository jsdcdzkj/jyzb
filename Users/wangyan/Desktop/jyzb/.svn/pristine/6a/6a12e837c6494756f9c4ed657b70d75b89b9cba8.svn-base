...
public class WarehouseStockController {
    ...
    @ResponseBody
    public ResultInfo toList(@RequestBody WarehousingStockDto warehousingStockDto) {
        PageInfo<WarehousingStock> page = warehouseStockService.pageQuery(warehousingStockDto);
    ...
    public ResultInfo detailUpdate(Integer id, Integer equip_num, String is_del) {
        ...
        if (equip_num != null && detail.getStock_type() == 0) {
