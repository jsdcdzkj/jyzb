<template>
  <div class="app-container">
    <div class="filter_container">
      ...
      <div class="filter_box">
        <el-form :inline="true" class="demo-form-inline topsearch" @submit.native.prevent>
          <el-form-item>
            <el-input v-model="listQuery.warehouse_name" size="small" placeholder="仓库名称" :maxlength="50" clearable @keyup.enter.native="search"/>
          </el-form-item>
          <el-form-item>
    ...
    <div class="content-box">
      <moduleTitle title="仓库列表"></moduleTitle>
 ...
 highlight-current-row>
          ...
          <el-table-column label="名称" prop="warehouse_name" align="center" show-overflow-tooltip></el-table-column>
          <el-table-column label="编码" prop="warehouse_code" align="center" show-overflow-tooltip></el-table-column>
...
import {getWarehouseList,delWarehouse} from '@/api/system'
export default {
  components: {
    Edit
  },
