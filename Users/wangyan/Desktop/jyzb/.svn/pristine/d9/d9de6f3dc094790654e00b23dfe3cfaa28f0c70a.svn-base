  ...
  <div class="app-container">
    ...
    <div class="container-main mt16">
      <div class="container-left">
        <div class="box-card">
          <moduleTitle title="特种装备数量趋势" :imgUrl="require('@/assets/layout/icon_qushi.png')"></moduleTitle>
          <div class="line-charts" style="margin-top: -34px;">
            <taskLine :valdata="taskLineData"></taskLine>
          </div>
        </div>
        <div class="box-card mt16">
          <moduleTitle title="特种装备类型分析" :imgUrl="require('@/assets/layout/icon_leixing.png')"></moduleTitle>
          <el-row :gutter="20" style="padding: 0 16px;">
            <el-col :span="12">
              <div class="pie-boxs pb16">
        ...
        <div class="box-card mt16">
          <moduleTitle title="分局特种装备数据" :imgUrl="require('@/assets/layout/icon_fenju.png')"></moduleTitle>
      ...
      <div class="container-right">
        <div class="box-card">
          <moduleTitle title="特种装备类型占比" :imgUrl="require('@/assets/layout/icon_all.png')"></moduleTitle>
